...
public class PickFragment extends Fragment implements PickContract.View {
    ...
    private PickContract.Presenter mPresenter;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mView = this;
        mPresenter = new PickPresenter(this);
    ...
    public void initLayout(ArrayList<ListResult.ResultData> list) {
        ...
        mAdapter = new PickAdapter(list, mItemClickListener);
